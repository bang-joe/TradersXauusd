...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ previewUrl, onChange }) => {
    return (
        <div>
            ...
            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-600 border-dashed rounded-md cursor-pointer hover:border-indigo-500 transition-colors duration-300 bg-gray-900/50">
                    ...
                    {previewUrl ? (
                        ...
                        <>
                            ...
                            <div className="flex text-sm text-gray-500">
                                <label
                                    htmlFor="file-upload"
                                    className="relative cursor-pointer rounded-md font-medium text-indigo-400 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-900 focus-within:ring-indigo-500"
                                >
             ...
             {previewUrl && (
                <div className="text-center mt-2">
                    <label
                        ...
                        className="cursor-pointer rounded-md font-medium text-sm text-indigo-400 hover:text-indigo-500"
                    >
                        Replace image
